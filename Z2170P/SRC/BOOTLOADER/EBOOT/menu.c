...
static OAL_BLMENU_ITEM g_menuBoardTest[] ={
    {
        L'1', L"Z2000 Device", OALBLMenuShow,
        L"Z2000 Test Management", &g_menuZ2000Test, L"2000"
    }, {
        L'2', L"Z2170P Device", OALBLMenuShow,
        L"Z2170P Test Management", &g_menu2170PTest, L"2170"
    }, {
        L'0', L"Exit and Continue", NULL,
        NULL, NULL, NULL
    }, {
...
#define DEFINE_LOGO  g_menuBoardTest[].pParam3
