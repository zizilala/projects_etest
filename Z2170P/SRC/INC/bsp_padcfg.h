...
#define DSS_PADS_37XX  \
    ...
    PAD_ENTRY(MCSPI1_CS1		,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 175 SYS_EN */ \
...
/* For Power 3.3 & 1.8, Ray 140109*/
#define POWER_ON_PADS \
    PAD_ENTRY(MMC2_DAT5,    INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 137 : EN_VIO_1V8_Z2170P */ \
    PAD_ENTRY(ETK_D9,       INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))  /* GPIO 23  : EN_DC_3V3   \
    
/* For LEDs, Ray 131227*/
#define LED_PADS \
    PAD_ENTRY(MCBSP_CLKS, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 160 : Barcode_led, Ray */   \
    PAD_ENTRY(MCBSP3_DX,  INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 140 : RED_LED, Ray */       \
    PAD_ENTRY(GPMC_A1,    INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 34  : GREEN_LED, Ray */     \

/* For Barcode, Ray, 131225*/
#define UART1_PADS \
...
/* For Fuel Gauge, Ray, 131128*/
#define I2C3_PADS   \
    PAD_ENTRY(I2C3_SCL, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))   \
    PAD_ENTRY(I2C3_SDA, INPUT_ENABLED | INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))   
...
/* brian for e-boot */
#define MCSPI1_EBOOT_PADS \
    PAD_ENTRY(MCSPI1_CS0, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) \
    PAD_ENTRY(MCSPI1_SIMO,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) \
    PAD_ENTRY(MCSPI1_CLK, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) 
    
/* 20130522-brian - for Touch panel */
#define MCSPI4_PADS \
    PAD_ENTRY(MCBSP1_FSX, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 161*/  \
    PAD_ENTRY(MCBSP1_DR,  INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))                    /* GPIO 159*/  \
    PAD_ENTRY(MCBSP1_DX,  INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 158*/  \
    PAD_ENTRY(MCBSP1_CLKR,INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))                    /* GPIO 156*/  \
...
#define GPIO_PADS_37XX   \
	...
	PAD_ENTRY(MCBSP4_FSX,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 155 : Keypad_led, Ray 131112 */ \
	PAD_ENTRY(MCBSP4_DR,	INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 153 : ENG_SET2 */ \
	PAD_ENTRY(MCBSP4_CLKX,	INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 152 : ENG_SET1 */ \
	PAD_ENTRY(MCBSP3_CLKX,	INPUT_ENABLED  | PULL_RESISTOR_ENABLED  | MUXMODE(4)) /* GPIO 142 : AC_nPG */ \
	...
	PAD_ENTRY(GPMC_A3,		INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 36 : nENG_TRIG */ \
	...
	PAD_ENTRY(GPMC_A10,		INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 43 : BATT_DCT */ \
    PAD_ENTRY(MMC2_DAT7,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 139 : EN_SB_CHG, Ray 140224 */ \
