...
{       \
    ...
    PAD_ENTRY(GPMC_A3             ,RELEASED_PAD_DEFAULT_CONFIG | MUXMODE(4))     \
    PAD_ENTRY(GPMC_A4             ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(GPMC_A5             ,RELEASED_PAD_DEFAULT_CONFIG | MUXMODE(4))     \
...
#define UART1_PADS \
    PAD_ENTRY(UART1_TX, INPUT_DISABLED | MUXMODE(4))     \
    PAD_ENTRY(UART1_RX, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(4))    \
    PAD_ENTRY(UART1_RTS, INPUT_DISABLED | MUXMODE(4))      \
    PAD_ENTRY(UART1_CTS, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))      \
...
#define GPIO_PADS_37XX   \
	...
	PAD_ENTRY(MCBSP4_FSX,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT | MUXMODE(4)) /* GPIO 155 : Keypad_led, Ray 131112 */ \
