...
#define I2C3_PADS   \
    ...
    PAD_ENTRY(I2C3_SDA, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))   
...
#define MCSPI4_PADS \
    PAD_ENTRY(MCBSP1_FSX, INPUT_DISABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT | MUXMODE(4)) /* GPIO 161*/  \
    PAD_ENTRY(MCBSP1_DR,  INPUT_ENABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_INPUT| MUXMODE(4))                    /* GPIO 159*/  \
    PAD_ENTRY(MCBSP1_DX,  INPUT_DISABLED | PULL_RESISTOR_DISABLED | GPIO_DIR_OUTPUT | MUXMODE(4)) /* GPIO 158*/  \
