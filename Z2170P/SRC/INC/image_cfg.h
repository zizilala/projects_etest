...
//
	...
	#define IMAGE_WINCE_RAM_SIZE		0x057FE000  // PRG666 RAM 32 MB  was 0x1FFE000
...
#define IMAGE_WINCE_DISPLAY_SIZE	0x00050000   // 320kB	; DMA buffer & display buffer for LCD
#define IMAGE_WINCE_RAM_BANK1_CA	0x88050000   // 
#define IMAGE_WINCE_RAM_BANK1_SIZE	0x07FB0000   // RAM (2nd BANK)  102 MB  
...
#define IMAGE_BOOTLOADER_BITMAP_SIZE	0x00100000				// Needs to be a multiple of 128k, and minimum 480x640x3=921600 (VGA)  
//#define IMAGE_BOOTLOADER_BITMAP_SIZE	0x00040000				// Needs to be a multiple of 128k, and minimum 320x240x3=230400 (VGA)  
...
//#define IMAGE_BOOTLOADER_NAND_SIZE	(0x80000 + 0x40000 + 0x40000 = 0x100000)
//------------------------------------------------------------------------------
